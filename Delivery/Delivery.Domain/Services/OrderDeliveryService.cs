...
namespace Delivery.Domain.Services
{
    ...
    {
        private readonly IOrderDelioveryRepository _orderRepository;
        ...
        public OrderDeliveryService(IConfiguration configuration, IOrderDelioveryRepository orderRepository)
        {
